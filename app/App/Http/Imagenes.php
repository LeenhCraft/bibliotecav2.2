...
class Imagenes
{
    ...
    public function escalarImg($escala, $img, $ancho, $alto, $nombreArchivo)
    {
    ...
    public function redimensionarImg($nuevoAncho, $nuevoAlto, $img, $width, $height, $nombreArchivo)
    {
